window.addEventListener("load", function () {
    ...
    document
        .querySelector(".preloader-active")
        .classList.remove("preloader-active");
...
var selectTwo = new Select("#select-two", {
...
var selectTree = new Select("#select-three", {
...
var selectFour = new Select("#select-four", {
...
var selectFive = new Select("#select-five", {
...
var selectSix = new Select("#select-six", {
...
var selectSeven = new Select("#select-seven", {
...
var selectEight = new Select("#select-eight", {
...
siteList[0].addEventListener("click", function (e) {
    if (e.target.classList.contains("site__mode")) {
        window.open("".concat(e.target.dataset.link));
    } else return;
});
siteList[1].addEventListener("click", function (e) {
    if (e.target.classList.contains("site__mode")) {
        window.open("".concat(e.target.dataset.link));
    } else return;
});